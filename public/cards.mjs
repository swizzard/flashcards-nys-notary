...
const cards = {
  ...
  misc: [
    ...
    { front: "বিনামূল‍্যে", front: "binamūlye\nfree of cost" },
    { front: "শিশু", front: "ʃiʃu\nchild, infant" },
    { front: "শিশুসেবা", front: "ʃiʃuseba\nchildcare" },
    { front: "নিরাপদ", front: "nirapôd\nsafe" },
    { front: "সড়ক", front: "sɔɽôk\nroad, street" },
    { front: "নির্বাচন", front: "nirbacôn\nelection, selection" },
    { front: "শময়", front: "sɔmôy\ntime" },
    { front: "খুঁজে নিন", front: "khũje nin\nfind out" },
  ],
  numerals: [
    { front: "১\nএক", back: "1" },
    { front: "২\nদুই", back: "2" },
